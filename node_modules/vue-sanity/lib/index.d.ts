...
import { SanityImageDimensions, FitMode } from '@sanity/image-url/lib/types/types';
import { QueryBuilder } from 'sanity-typed-queries';

declare type FetchStatus = 'initialised' | 'loading' | 'server loaded' | 'client loaded' | 'error';
...
declare function useCache<T, K = null>(key: string | Ref<string>, fetcher: (key: string) => Promise<T>, options?: CacheOptions<K>): {
    setCache: ({ key, value, status, error, promise, }: SetCacheOptions<T, K>) => void;
 ...
 */
declare function useSanityImage(image: Ref<ResolvedSanityImage>, options?: Partial<ImageOptions>, widths?: number[]): _vue_composition_api.ComputedRef<{
    srcset: string;
    placeholder: string;
    src: string;
}>;
 ...
 */
declare function useSanityFetcher<T, R = T>(query: Query, initialValue: R, mapper?: (result: any) => T, options?: Options): Result<T | R>;
declare function useSanityQuery<Builder extends Pick<QueryBuilder<Schema, Mappings, Type, Project, Exclude>, 'use'>, Schema, Mappings extends Record<string, any>, Type, Project extends boolean, Exclude extends string>(builder: Builder | (() => Builder)): Result<ReturnType<Builder['use']>[1] extends Array<any> ? ReturnType<Builder['use']>[1] : ReturnType<Builder['use']>[1] | null>;
declare function useSanityQuery<Builder extends Pick<QueryBuilder<Schema, Mappings, Type, Project, Exclude>, 'use'>, Schema, Mappings extends Record<string, any>, Type, Project extends boolean, Exclude extends string>(builder: Builder | (() => Builder), initialValue: null): Result<ReturnType<Builder['use']>[1] | null>;
declare function useSanityQuery<Builder extends Pick<QueryBuilder<Schema, Mappings, Type, Project, Exclude>, 'use'>, Schema, Mappings extends Record<string, any>, Type, Project extends boolean, Exclude extends string, InitialValue>(builder: Builder | (() => Builder), initialValue: InitialValue): Result<ReturnType<Builder['use']>[1] | InitialValue>;
declare function useSanityQuery<Builder extends Pick<QueryBuilder<Schema, Mappings, Type, Project, Exclude>, 'use'>, Schema, Mappings extends Record<string, any>, Type, Project extends boolean, Exclude extends string, Mapper extends (result: ReturnType<Builder['use']>[1]) => any>(builder: Builder | (() => Builder), initialValue: null, mapper: Mapper, options?: Options): Result<ReturnType<Mapper> | null>;
declare function useSanityQuery<Builder extends Pick<QueryBuilder<Schema, Mappings, Type, Project, Exclude>, 'use'>, Schema, Mappings extends Record<string, any>, Type, Project extends boolean, Exclude extends string, InitialValue, Mapper extends (result: ReturnType<Builder['use']>[1]) => any>(builder: Builder | (() => Builder), initialValue: InitialValue, mapper: Mapper, options?: Options): Result<ReturnType<Mapper> | InitialValue>;
 ...
 */
declare function useSanityClient(config: ClientConfig & RequiredConfig, supportPreview?: boolean, defaultOptions?: Options): void;
...
export { CacheOptions, FetchStatus, Options, fetch, useCache, useCustomClient, useSanityClient, useSanityFetcher, useSanityImage, useSanityQuery };
